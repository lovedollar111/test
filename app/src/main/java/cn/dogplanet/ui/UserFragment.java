...
public class UserFragment extends BaseFragment {
    ...
    private void updateView(SharePersonResp.InviteArr inviteArr) {
        if (Expert.AUTHENTICATION_20 == expert.getAuthentication_status()) {
            ...
            imgInvite.setImageResource(R.drawable.ic_invite_select);
        } else {
            ToastUtil.showError("通过认证审核后才可邀请好友");
            imgInvite.setImageResource(R.drawable.ic_invite_normal);
        }
