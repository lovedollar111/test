...
public class CartAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			item = new ViewHolder();
			item.product_img = (CircleImageView) convertView
					.findViewById(R.id.product_img);
			item.tv_name = (TextView) convertView.findViewById(R.id.tv_name);
			item.tv_date = (TextView) convertView.findViewById(R.id.tv_date);
			item.tv_num = (TextView) convertView.findViewById(R.id.tv_num);
			item.tv_money = (TextView) convertView.findViewById(R.id.tv_money);
			item.ck_checkbox = (CheckBox) convertView
					.findViewById(R.id.ck_checkbox);
			item.layout = (LinearLayout) convertView.findViewById(R.id.lay_chk);
			item.lay_msg = (RelativeLayout) convertView
					.findViewById(R.id.lay_msg);
			item.pro_status= (TextView) convertView.findViewById(R.id.pro_status);
			if (isGone) {
