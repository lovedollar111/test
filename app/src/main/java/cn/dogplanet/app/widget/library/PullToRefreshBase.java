 ...
 *******************************************************************************/
package cn.dogplanet.app.widget.library;
...
import cn.dogplanet.app.widget.library.internal.FlipLoadingLayout;
import cn.dogplanet.app.widget.library.internal.LoadingLayout;
import cn.dogplanet.app.widget.library.internal.RotateLoadingLayout;
import cn.dogplanet.app.widget.library.internal.Utils;
import cn.dogplanet.app.widget.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		// Styleables from XML
		@SuppressLint("CustomViewStyleable") TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PullToRefresh);
