...
public class MessageStatusRecogListener extends StatusRecogListener {
    ...
    public void onAsrFinishError(int errorCode, int subErrorCode, String descMessage,
        ...
        sendStatusMessage(SpeechConstant.CALLBACK_EVENT_ASR_PARTIAL, descMessage);
        speechEndTime = 0;
        sendMessage(descMessage, status, true);
        speechEndTime = 0;
    }
    ...
    public void onAsrVolume(int volumePercent, int volume) {
        ...
        sendMessage(String.valueOf(volumePercent), status, false);
    }
    ...
    private void sendMessage(String message, int what, boolean highlight) {
        ...
        msg.obj = message;
        Log.i(TAG,"msg   "+message+"  "+msg.what+"  "+msg.arg1);
